"""Tests for RLAP app router."""

import pytest
from rlap.router import register, unregister, get_app, list_apps, dispatch_incoming, dispatch_outgoing
from rlap.errors import UnknownApp
