...
try:
    ...
    print("Install with: pip install rlap[rns]")
    sys.exit(1)

from rlap.apps.tictactoe import TicTacToeApp
from rlap.transport import RlapTransport
from rlap.envelope import pack_envelope
from rlap.router import register, dispatch_incoming
from rlap.constants import CMD_CHALLENGE, CMD_ACCEPT, CMD_MOVE


def main():
    print("=== RLAP Tic-Tac-Toe over LXMF ===")
    ...
    # Create RLAP transports
    transport_x = RlapTransport(router_x, id_x)
    transport_o = RlapTransport(router_o, id_o)
