...
from rlap.apps.tictactoe import TicTacToeApp, EMPTY_BOARD, _check_winner, _check_draw
from rlap.envelope import pack_envelope, validate_envelope_size
from rlap.constants import CMD_CHALLENGE, CMD_ACCEPT, CMD_MOVE, CMD_RESIGN
...
def main():
    ...
    print("=== RLAP Tic-Tac-Toe Local Simulation ===")
    print()
